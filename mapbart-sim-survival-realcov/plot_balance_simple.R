...
ggsave(paste0(file.path(mainDir),"/mapbart-sim-gaussian/manuscript/inserts/balanced_1_surv_real", size_suffix, ".jpg"),
       width = 16,
       height = 3,
       p_km_final,
       limitsize = FALSE)
...
ggsave(paste0(file.path(mainDir),"/mapbart-sim-gaussian/manuscript/inserts/balanced_2_surv_real", size_suffix, ".jpg"),
       width = 14,
       height = plot_height,
       p_balance,
       limitsize = FALSE)
