...
## Survival counterpart of ../../mapbart-sim-gaussian/ess_local/ess_calibration.R.
##
...
## /Users/oliviazhang/Desktop/mapbart-historical-borrowing/mapbart-sim-survival/data_v2/, D == 0 & Z == 0
...
default_data  <- "/Users/oliviazhang/Desktop/mapbart-historical-borrowing/mapbart-sim-survival/data_v2"
...
.stale  <- file.path(.resDir, c(
  sprintf("ess_calibration_%s%s.RData",            map_model, sc_suffix),
  sprintf("ess_calibration_%s%s_checkpoint.RData", map_model, sc_suffix)))
...
ESSbar <- t(sapply(valid_results, `[[`, "ESSbar_b"))
