...
if (hypo == "alternative") {
  ...
  if (sc == 1 | sc == 2) {
    if (is.null(subsc)) {
      threshold_file <- paste0(mainDir, "/mapbart-sim-survival/res/AFTv3_p", p_obs, "_sc", sc, "_threshold.RData")
    } else {
      threshold_file <- paste0(mainDir, "/mapbart-sim-survival/res/AFTv3_p", p_obs, "_sc", sc, subsc, "_threshold.RData")
    }
  } else {
    if (is.null(subsc)) {
      threshold_file <- paste0(mainDir, "/mapbart-sim-survival/res/AFTv3_p", p_obs, "_sc", sc, "_cor", cor, "_threshold.RData")
    } else {
      threshold_file <- paste0(mainDir, "/mapbart-sim-survival/res/AFTv3_p", p_obs, "_sc", sc, subsc, "_cor", cor, "_threshold.RData")
    }
  }
...
if (hypo == "null") {
  ...
  if (sc == 1 | sc == 2) {
    ...
    if (is.null(subsc)) {
      threshold_file <- paste0(mainDir, "/mapbart-sim-survival/res/AFTv3_p", p_obs, "_sc", sc, "_cor", c, "_threshold.RData")
    } else {
      threshold_file <- paste0(mainDir, "/mapbart-sim-survival/res/AFTv3_p", p_obs, "_sc", sc, subsc, "_cor", c, "_threshold.RData")
    }
  }
...
if (sc == 1 | sc == 2) {
  if (is.null(subsc)) {
    saveRDS(res, file=paste0(mainDir,"/mapbart-sim-survival/res/AFTv3_p",p_obs,"_sc",sc,"_",hypo,".RData"))
  } else {
    saveRDS(res, file=paste0(mainDir,"/mapbart-sim-survival/res/AFTv3_p",p_obs,"_sc",sc,subsc,"_",hypo,".RData"))
  }
} else {
  if (is.null(subsc)) {
    saveRDS(res, file=paste0(mainDir,"/mapbart-sim-survival/res/AFTv3_p",p_obs,"_sc",sc,"_cor",c,"_",hypo,".RData"))
  } else {
    saveRDS(res, file=paste0(mainDir,"/mapbart-sim-survival/res/AFTv3_p",p_obs,"_sc",sc,subsc,"_cor",c,"_",hypo,".RData"))
  }
}
