## ess_plot.R -- ESS-calibration figure (BART only).
##
## Loads a BART calibration .RData (ess_calibration.R) and draws a single
## figure:
##
...
##
## Works for both calibration setups (BART boxes only):
##   * ess_local Gaussian   (ess_calibration.R)
...
## --resdir (default: this script's own res/).  The output PNG defaults
## to the BART .RData's name with a .png extension, so OS / PFS / source
## variants never clobber each other.
