...
1. `05-writing/next_revision_report.md`.
...
| Cumulative tracked changes, 99 pages | `05-writing/main_tracked.tex`, `main_tracked.pdf` |
...
Main text: 7,220 texcount text words including the 227-word abstract; 6,993 excluding it. Separate tables, mathematical-expression counts, headings and captions are excluded.
