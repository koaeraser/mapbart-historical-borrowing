...
`main_lrcbart.pdf` is the 25-slide author presentation. The leaf mixture is on slide 6, the induced pointwise mixture for f1 on slide 7, and the discrepancy-tree diagram on slide 8. The September 11 prose pass preserves the scientific content, numbers, tables, equations and figures.
