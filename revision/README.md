...
Start with the [paper](05-writing/main_draft.pdf), [cumulative tracked changes](05-writing/main_tracked.pdf), and [latest leaf-prior clarification](review/leaf_prior_clarity_20260910/report.md). The current paper is 79 pages with 6,961 main-text words excluding its 227-word abstract. The [25-slide deck](06-slides/main_lrcbart.pdf) is synchronized, including explicit all-spike conditioning and an indicator-dependent leaf variance. Equation (2) defines theta_hl and uses tau_{1-z_hl}^2; the paper spells out the all-slab and mixed-indicator priors for f_1. The cumulative redline is 101 pages.
