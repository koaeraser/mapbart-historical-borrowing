...
Start with the [paper](05-writing/main_draft.pdf), [cumulative tracked changes](05-writing/main_tracked.pdf), and [latest prior-mixture presentation](review/prior_mixture_order_20260910/report.md). The current paper is 79 pages with 6,932 main-text words excluding its 227-word abstract. The [25-slide deck](06-slides/main_lrcbart.pdf) is synchronized, with the explicit leaf mixture on slide 6, induced pointwise control-mean mixture on slide 7, and model diagram on slide 8. The [September 11 slide update](review/slide_mixture_sync_20260911/report.md) records the synchronization and QA. Equation (2) presents the leaf mixture, followed by the induced pointwise mixture for f_1. The all-spike and all-slab components and the equivalent tau_{1-z_hl}^2 representation are explained in prose. The cumulative redline is 101 pages.
