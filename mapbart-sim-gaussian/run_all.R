...
script_dir <- file.path(mainDir, "mapbart-sim-gaussian")
...
# ---- Analysis files ----
files <- c("LMv1.R", "LMv2.R", "LMv3.R", "BARTv1.R", "BARTv2.R", "BARTv3.R", "PSCL.R", "MAP.R", "HierLM.R", "mBART.R")
...
# -> "invalid connection". So the Stan/RBesT methods run serially; only the
# fork-safe ones (BART C++ and PSCL) go in the parallel batch.
